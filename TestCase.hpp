	...
	TestCase(const string str, ostream& in) : os(in)
{
	...
	TestCase check_equal(T a, T b)
	{
		if(a==b)
		{
			...
			falseTest++;
			os << test_name<< ": Failure in test #"<<falseTest+trueTest<<
					": Function should return "<<a<<" but returned "<<b<<"!" << endl;
	...
	TestCase check_different(T a, T b)
	{
		if(a!=b)
		{
			...
			falseTest++;
			os << test_name+ ": Failure in test #"<<falseTest+trueTest<<": Function should return "
					<<a<<" but returned "<<b<<"!" << endl;
